...
This directory contains source files for the Nenets language morphology
...
In order to compile and use Nenets language morphology and dictionaries,
you need:
...
The Nenets language sources can be acquired using [giella SVN
